...
```python
# oms_test/utils/kafka/kafka_python_interface.py
import random
import loguru
import asyncio
from oms_test.settings import KAFKA_LOG, KAFKA_HOSTS
...
# 运行结果示例：
2021-02-22 14:38:57.485 | WARNING  | __main__:produce_msg:98 - 发送 1 条消息：['this is a test...'] 到主题：[store_topic], partition:0
2021-02-22 14:38:57.488 | WARNING  | __main__:receive:48 - ======== kafka 消费者事件循环开启 ========
